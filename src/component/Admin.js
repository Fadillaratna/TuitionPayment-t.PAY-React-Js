        ...
        return (
            <div className="petugas">
                <div className="dashboard ms-5"><br/><br/>
                    <br></br><br></br><br></br>
                    <h5 className="card-title display-3 fw-bolder mb-0">ADMIN LIST</h5>
                    <p className="card-text lead fs-2 mb-3">t.PAY</p>
                    <button type="button" className="btn btn-dark mb-5" onClick={this.Add} data-toggle="modal" data-target="#modal">Add Admin</button>
                            ...
                            {this.state.petugas.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>{item.telepon}</td>
                                        <td>
                                            <button className="btn btn-sm btn-dark m1 me-1" onClick={() => this.Edit(item)} data-toggle="modal" data-target="#modal"><i className="fa fa-pencil"></i></button>
                                            <button className="btn btn-sm btn-outline-dark m1" onClick={() => this.Drop(index)}><i className="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                );
                            })}
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form onSubmit={this.SavePetugas}>
                                    ...
                                    <br></br>
                                    <button className="btn btn-dark btn-block" type="submit">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
