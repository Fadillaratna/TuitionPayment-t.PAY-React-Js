        ...
        return (
            <div className="siswa">
                <div className="dashboard ms-5"><br></br><br></br>
                    ...
                    <button type="button" className="btn btn-dark mb-5" onClick={this.Add} data-toggle="modal" data-target="#modal">Add Class</button>
                        ...
                        {this.state.kelas.map((item, index) => {
                            return (
                                <li className="list-group-item flush" key={index}>
                                    ...
                                    <button className="btn btn-sm btn-dark m1 me-2" onClick={() => this.Edit(item)} data-toggle="modal" data-target="#modal">Edit</button>
