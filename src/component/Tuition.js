            ...
            <div className="spp">
                <div className="dashboard-spp ms-5"><br></br><br></br>
                    ...
                    <div className='content'>
                                    ...
                                    <div className="card">
                                        <div className="card-body row">
                                            ...
                                            <div className="col-7">
                                                ...
                                                <button className="btn btn-sm btn-dark m1 me-2" onClick={() => this.Edit(item)} data-toggle="modal" data-target="#modal_spp"><i className="fa fa-pencil"></i></button>
                        ...
                        <button type="button" data-toggle="modal" data-target="#modal_spp" className="btn btn-dark mb-2 mt-2" onClick={() => this.Add()}>Add Tuition</button>
